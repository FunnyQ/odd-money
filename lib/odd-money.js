...
var _currency_iso = __webpack_require__(7);
...
var Money = function () {
  function Money(cents, currency) {
    var currencies = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _currency_iso2.default;

    _classCallCheck(this, Money);

    if ((0, _lodash10.default)(currency)) currency = currencies[currency];
    ...
    (0, _lodash2.default)(this, currencies);
  ...
  _createClass(Money, [{
    ...
    value: function format() {
      ...
      var result = this.amount.toLocaleString();

      if (options['withSymbol']) {
        result = this.currencyData.symbol_first ? '' + this.currencyData.symbol + result : '' + result + this.currencyData.symbol;
      }
    ...
    value: function multiply(multiplier) {
      var rounder = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Math.round;

      if (!(0, _lodash4.default)(rounder)) throw new TypeError('rounder must be a function');
      testOperand(multiplier);

      var result = rounder(this.cents * multiplier);
    ...
    value: function divide(divisor) {
      ...
      var result = rounder(this.cents / divisor);
