...
var Money = function () {
  ...
  _createClass(Money, [{
    ...
    value: function multiply(multiplier) {
      ...
      var result = rounder(this.amount * multiplier, this.currencyData.smallest_denomination) * this.currencyData.subunit_to_unit;
    ...
    value: function divide(divisor) {
      ...
      var result = rounder(this.amount / divisor, this.currencyData.smallest_denomination) * this.currencyData.subunit_to_unit;
